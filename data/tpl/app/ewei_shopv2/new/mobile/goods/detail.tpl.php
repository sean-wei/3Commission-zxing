...
<div class="comm-rates">佣金比例<?php  echo $goods['commissionRate'];?>% , 预计赚 <?php  echo $goods['seecommission'];?>元</div>
<?php  } ?>
...
<div class="fui-cell-group fui-detail-group" >
    ...
    <div class="comm-ratesBodyeH4"  style="right: 10px;">
        <a class="fui-cell-remark share" <?php  if(!empty($goods['sharebtn']) && $member['isagent']==1 && $member['status']==1) { ?> href="<?php  echo mobileUrl('commission/qrcode', array('goodsid'=>$goods['id']))?>" <?php  } else { ?> id='btn-share' <?php  } ?>>
            <img src="<?php  echo EWEI_SHOPV2_LOCAL?>static/new/fx.png">
            <p>分享</p>
        </a>
    </div>
    <?php  } ?>
    ...
    <div class="fui-cell goods-subtitle">
        <span class='text-danger' style="padding-right: 70px;font-size: 12px"><?php  echo $goods['subtitle'];?></span>
    </div>
    <?php  } ?>
    ...
    <div class="fui-cell">
        <div class="fui-cell-text price" >
			...
			<span class="text-danger" style="vertical-align: middle;color: #c2a674">
                <!--任务-->
            ...
            <span style="float: right;color: #888;font-size: 5px; margin-right: 12px;">销量：<?php  echo number_format($goods['sales'],0)?> <?php  echo $goods['unit'];?> </span>
            <?php  } ?>
        </div>
...
<div class="fui-cell-group  fui-sale-group nomargin">
    ...
    <div class="fui-cell fui-sale-cell" id="picker-sales">
        ...
        <div class="fui-cell-text">
            ...
            <div class="sale-line">
                <span class="sale-tip" style="color: #c2a674;border: 1px solid #c2a674;">满减</span>
                <span>全场满 <span class="text-danger" style="color: #c2a674;" >&yen;<?php  echo $enoughs[0]['enough'];?></span> 立减 <span class="text-danger" style="color: #c2a674">&yen;<?php  echo $enoughs[0]['money'];?></span></span>
            </div>
            <?php  } ?>
...
<div class='fui-according-group'>
    <div class='fui-according expanded'>
        <div class='fui-according-header'>
            ...
            <span class="remark"><div class="badge" style="background-color: #c2a674;"><?php  echo count($stores)?></div></span>
        </div>
...
<div class="fui-navbar bottom-buttons">
    <?php  if(p('offic') && $opencommission && $member['isagent'] == 1 && $member['status'] == 1) { ?>
        ...
        <a class="nav-item cart-item external" href="<?php  echo mobileUrl('member/cart')?>" data-nocache="true" he="" id="menucart">
            <span class='badge <?php  if($cartCount<=0) { ?>out<?php  } else { ?>in<?php  } ?>'
    ...
    <!--todo 客服-->
    <a  class="nav-item favorite-item" data-isfavorite="<?php  echo intval($isFavorite)?>">
        <!--<span class="icon <?php  if($isFavorite) { ?>icon-likefill<?php  } else { ?>icon-like<?php  } ?>"></span>-->
        <span><img style="height: 25px;" src="<?php  echo EWEI_SHOPV2_LOCAL?>static/new/fonl01.png"></span>
        <span class="label" >客服</span>
    </a>

        <a  style="width: 1%" class="nav-item favorite-item <?php  if($isFavorite) { ?>active<?php  } ?>" data-isfavorite="<?php  echo intval($isFavorite)?>">
            <span class="icon <?php  if($isFavorite) { ?>icon-likefill<?php  } else { ?>icon-like<?php  } ?>"></span>
            <!--<span><img style="height: 25px;"-->
                       <!--src="<?php  if($isFavorite) { ?><?php  echo EWEI_SHOPV2_LOCAL?>static/new/fonl02Hover.png<?php  } else { ?><?php  echo EWEI_SHOPV2_LOCAL?>static/new/fonl02.png<?php  } ?>"></span>-->
        ...
        <a class="nav-item cart-item" href="<?php  echo mobileUrl('member/cart')?>" data-nocache="true" he="" id="menucart">
            <span class='badge <?php  if($cartCount<=0) { ?>out<?php  } else { ?>in<?php  } ?>' style="background-color:#c2a674; width: 18px;
    height: 18px; "><?php  echo $cartCount;?></span>
            <!--<span class="icon icon-cart"></span>-->
            <span><img style="height: 25px;" src="<?php  echo EWEI_SHOPV2_LOCAL?>static/new/fonl03.png"></span>
            <span class="label">购物车</span>
        </a>
        <?php  if($canAddCart) { ?>
            <?php  if(!isset($_GPC['taskrewardgoodsid'])) { ?>
                <a  class="nav-item btn cartbtn" style="background-color: #a1a3b0;font-size: 15px;" data-type="<?php  echo $goods['type'];?>">加入购物车</a>
            <?php  } ?>
        <?php  } ?>
        <?php  if(!empty($seckillinfo) && $seckillinfo['status']==1) { ?>
            <a  class="nav-item btn buybtn seckill-notstart">原价购买</a>
        <?php  } else { ?>
            <a  class="nav-item btn buybtn" style="background-color: #c2a674;font-size: 15px;" data-type="<?php  echo $goods['type'];?>">立即预约</a>
        <?php  } ?>
