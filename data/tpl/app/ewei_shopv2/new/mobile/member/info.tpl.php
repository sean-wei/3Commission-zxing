	...
	<div class='fui-content'>
		...
		<div class="fui-list-group">
			...
			<div class="van-uploader clearfix" id="btn-avatar">
				...
				<p style="font-size: 13px;line-height: 2;color: #333333;padding:10px 0px">上传头像</p>
		...
		<div class="fui-cell-group">
			...
			<div class="fui-cell">
				<div class="fui-cell-label">生日</div>
		...
		<?php  } ?>
		<div class="clearfix lCenterForm-grop" style="border:none;padding-top: 20px;"><a href='#' id='btn-submit' class='lCenterForm-gropButton' style="background-color: darkgrey;font-size: 15px;">确认修改</a></div>
