...
<div class="fui-page fui-page-current page-commission-index ">
	...
	<div class="headinfo">
	    <div class='fui-list detail' style="background-color: #ceb78b">
	...
	<div class='fui-cell-group'>
		...
		<div class='fui-cell-remark noremark' ><span class="text-orange" style="color: #ceb78b"><?php  echo number_format($member['commission_ok'],2)?> <?php  echo $this->set['texts']['yuan']?></span></div>
	    </div>
	</div>
	...
	<div class='fui-according-group'>
		...
		<div class='fui-according-content'>
		    ...
		    买家确认收货（<span class='text-orange' style="color: #ceb78b"><?php  echo $this->set['settledays']?>天</span> )后，
		    ...
		    <?php  } ?>
		    <?php  if($this->set['withdraw']>0) { ?><br/>注意：可用<?php  echo $this->set['texts']['commission']?>满 <span class='text-orange' style="color: #ceb78b"><?php  echo $this->set['withdraw']?><?php  echo $this->set['texts']['yuan']?></span> 后才能申请<?php  echo $this->set['texts']['withdraw']?><?php  } ?>
		    </div>
		</div>
		...
		<a  style="height: 36px;width: 94%;background: #ceb78b;border: 1px solid #ceb78b;" <?php  if($cansettle ) { ?>href="<?php  echo mobileUrl('commission/apply')?>"<?php  } ?> class="nav-item btn btn-warning block<?php  if(!$cansettle ) { ?> disabled<?php  } ?>">我要提现</a>
