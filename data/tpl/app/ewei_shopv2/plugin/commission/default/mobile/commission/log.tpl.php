...
<div class="fui-page fui-page-current page-commission-log">
    ...
    <div class="fui-content navbar">
		...
		<div class='fui-cell-group' style='margin-top:0px;background: #ceb78b;color: #fff;'>
			<div class='fui-cell'>
    ...
    <a href="<?php  echo mobileUrl('commission/log/detail')?>&id=<%log.id%>" data-nocache="true" style=" display:block;margin-top: .5rem;">
        <div class="fui-list">
            ...
            <div class="row-remark">
                ...
                <p style="<%if log.status==1%>color:#ceb78b;<%else if log.status==2%>color:#ff5555;<%else if log.status==3%>color:#04ab02;<%else%>color:#b2b2b2;<%/if%>"><%log.statusstr%></p>
            </div>
        </div>
